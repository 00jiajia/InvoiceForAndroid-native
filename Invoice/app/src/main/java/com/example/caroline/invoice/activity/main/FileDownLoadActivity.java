...
import com.example.caroline.invoice.BuildConfig;
...
public class FileDownLoadActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        button_load=(Button) findViewById(R.id.button_download);
        button_load.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String filePath= UploadUtil.downloadFile(url);
                Toast.makeText(FileDownLoadActivity.this,filePath,Toast.LENGTH_LONG).show();
                openFile(FileDownLoadActivity.this,new File(filePath));
            }
        });
